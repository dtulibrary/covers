...
4a. Insert the path to where you stored the proxy.war file, where it says "INSERT PATH TO WAR"

       It should look something like this:
       <Context docBase="path.to.your.war.file/proxy.war" debug="0" crossContext="true" >

4b. Insert your api key where it says "INSERT API KEY".

       It should look something like this:
       <Environment name="dadscis.apiKey" value="yourApiKey" type="java.lang.String" override="false"/>

4c. Notice the "dadscis.imageServiceUrl" parameter in the proxy.xml file. You can change this configuration to target the another stage in  our development of DADS CIS.

       The different server options can be found on our wiki: https://infoshare.dtv.dk/twiki/bin/view/DADS/CIS
       It should be noted, that the "dadscis.imageServiceUrl" parameter always should point to the api like "http://staging.imageservice.cvt.dk/api"

5. Restart your Tomcat.

6. Your proxy is now up and running.
